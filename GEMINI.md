...
1. **Arquitectura Empresarial Estricta:** 
   ...
   - **Separación de Estilos Obligatoria:** Todos los componentes y pantallas deben tratar sus estilos como externos, asumiendo una escala de +1000 líneas. Los estilos NUNCA deben vivir en el mismo archivo que el JSX. Deben residir en un archivo `.styles.js` adyacente.
